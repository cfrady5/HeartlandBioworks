...
<head>
  ...
  <title>News & Media – Heartland BioWorks</title>
...
<body data-page="news" data-breadcrumb="Resources > News &amp; Media">
<div id="hb-header"></div>

<section class="hb-pagehero">
  <div class="hb-pagehero-inner">
    <h1>News &amp; Media</h1>
    <p>Announcements, press releases, media mentions, and updates from Heartland BioWorks and Indiana's biomanufacturing ecosystem.</p>
  </div>
</section>

<main class="hb-pagebody">
  <div class="hb-pagebody-inner">
    <!-- Rendered from the shared content store (assets/content-pages.js).
         Staff manage these items from dashboard.html. -->
    <div id="hb-content" data-content="news"></div>
  </div>
</main>
