...
<head>
  ...
  <title>Upcoming Events – Heartland BioWorks</title>
...
<body data-page="events" data-breadcrumb="Resources > Upcoming Events">
<div id="hb-header"></div>

<section class="hb-pagehero">
  <div class="hb-pagehero-inner">
    <h1>Upcoming Events</h1>
    <p>Workshops, webinars, info sessions, deadlines, and partner events across Indiana's biomanufacturing ecosystem.</p>
  </div>
</section>

<main class="hb-pagebody">
  <div class="hb-pagebody-inner">
    <div id="hb-content" data-content="events"></div>
  </div>
</main>
