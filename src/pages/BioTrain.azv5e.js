...
<nav class="nav">
  <div class="container nav-inner">
    <a href="/" class="nav-logo" aria-label="Heartland BioWorks Home">
...
<footer style="background:#050E18;padding:32px 0;text-align:center;font-size:.82rem;color:rgba(255,255,255,.3);">
  <div class="container">
    <a href="/" style="display:inline-block;margin-bottom:14px;">
      <img src="https://static.wixstatic.com/media/fcced6_f19335b6f6ed433b9a5c9a2294f3db1a~mv2.png" alt="Heartland BioWorks" style="height:34px;opacity:.65;margin:0 auto;" />
    </a>
